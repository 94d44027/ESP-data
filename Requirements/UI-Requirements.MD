...
- Each edge SHALL include at minimum: Each edge SHALL include: `source`, `target` (Edge `id` is auto-generated by Cytoscape. Edge `label` is deferred to future release.)
